...
cbind(swiss.lm.coef.1, swiss.lm.coef.2, swiss.lm.coef.3)
```
...
## The resulting objects do not look any different.
...
gapminder$G8 [gapminder$country %in% c("United States", "Germany", "Italy", "the United Kingdom", "Japan", "France","Canada", "Russia")] <- 1 
```
